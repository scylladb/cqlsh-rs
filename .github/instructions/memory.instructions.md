...
## Never create worktrees in /tmp

Always use `.worktrees/` directory within the project (e.g., `.worktrees/fix-157`) instead of `/tmp/opencode/`. Project worktrees belong with the project.
