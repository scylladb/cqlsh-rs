...
///
/// Delegates to the unified CQL lexer for context-aware comment stripping.
/// Handles nested block comments and preserves content inside string literals.
fn strip_comments(input: &str) -> String {
    crate::cql_lexer::strip_comments(input)
}
